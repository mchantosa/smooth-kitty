    ...
    <div class="bg-white flex flex-col md:flex-row w-full max-w-screen-lg gap-8 md:gap-16 px-8 py-8 text-sm">
      <div class="flex-1">
        <div class="flex items-center gap-1">
          <img src="/images/connections-logo.png" width={36} height={36} />
          <div class="font-bold text-2xl">Connections</div>
        </div>
        <div class="text-gray-500">Meaningful communication</div>
      </div>
