...
import * as $9 from "./routes/api/contacts/index.ts";
import * as $10 from "./routes/api/contacts/seed.ts";
import * as $11 from "./routes/api/items/[id]/comments.ts";
import * as $12 from "./routes/api/items/[id]/index.ts";
import * as $13 from "./routes/api/items/[id]/vote.ts";
import * as $14 from "./routes/api/items/index.ts";
import * as $15 from "./routes/api/me/notifications.ts";
import * as $16 from "./routes/api/me/votes.ts";
import * as $17 from "./routes/api/stripe-webhooks.ts";
import * as $18 from "./routes/api/users/[login]/index.ts";
import * as $19 from "./routes/api/users/[login]/items.ts";
import * as $20 from "./routes/api/users/index.ts";
...
import * as $26 from "./routes/feed.ts";
import * as $27 from "./routes/index.tsx";
import * as $28 from "./routes/items/[id].tsx";
import * as $29 from "./routes/notifications/[id].ts";
...
const manifest = {
  routes: {
    ...
    "./routes/api/contacts/index.ts": $9,
    "./routes/api/contacts/seed.ts": $10,
    "./routes/api/items/[id]/comments.ts": $11,
    "./routes/api/items/[id]/index.ts": $12,
    "./routes/api/items/[id]/vote.ts": $13,
    "./routes/api/items/index.ts": $14,
    "./routes/api/me/notifications.ts": $15,
    "./routes/api/me/votes.ts": $16,
    "./routes/api/stripe-webhooks.ts": $17,
    "./routes/api/users/[login]/index.ts": $18,
    "./routes/api/users/[login]/items.ts": $19,
    "./routes/api/users/index.ts": $20,
    ...
    "./routes/feed.ts": $26,
    "./routes/index.tsx": $27,
    "./routes/items/[id].tsx": $28,
    "./routes/notifications/[id].ts": $29,
